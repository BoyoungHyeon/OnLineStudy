...
public class JSONManager {
	...
	public static void main(String[] args) {
		 ...
		 * //URL주소 연결 Document doc=Jsoup.connect(url).get();er(); JSONArray
		 * arr=(JSONArray)jp.parse(movie_data); System.out.println
		 * //System.out.println(doc.toString()); // <body>태그안에 있는 데이터만 읽기
		 * 
		 * Element json=doc.selectFirst("body"); //System.out.println(json.text());
		 * String movie_data=json.text(); JSONParser jp=new JSONPars(arr.toJSONString());
