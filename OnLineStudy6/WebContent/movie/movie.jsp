...
h1 {
   text-align: center; /*문자열을 가운데 정렬할때*/
}
</style>
</head>
<body>
   <div class="container">
      ...
      <div class="row">
         <%-- 링크 --%>
         <%--
       모든 태그를 버튼화 : Class="btn btn-sm btn-색상값"
       --%>
         <a href="movie.jsp?no=1" class="btn btn-lg btn-primary">박스 오피스</a> <a
            href="movie.jsp?no=2" class="btn btn-lg btn-success">실시간 예매율</a> <a
            href="movie.jsp?no=3" class="btn btn-lg btn-info">좌석 점유율</a> <a
            href="movie.jsp?no=4" class="btn btn-lg btn-danger">온라인상영관 일일</a>
      </div>
      <div class="row">
